...
#define NEXUS_INTERFACE_VERSION 4
...
#define NEXUS_CRYPTO_BLOWFISH_SHA1        ((crypto_t)  0x0001)
#define NEXUS_CRYPTO_BLOWFISH_SHA1_COMPAT ((crypto_t)  0x0002)
#define NEXUS_COMPRESS_NONE               ((compress_t)0x0001)
#define NEXUS_COMPRESS_ZLIB               ((compress_t)0x0002)
#define NEXUS_COMPRESS_LZF                ((compress_t)0x0004)
